...
namespace FoodyWebApplication.Controllers
{
    public class OrderDetailController : Controller
    {
        ...
        public OrderDetailController(FoodyContext context)
        {
            _context = context;
        }
        ...
        {
            var foodyContext = _context.OrderDetails.Include(o => o.Order).Include(o => o.Product);
        ...
        public async Task<IActionResult> Create([Bind("OrderId,ProductId,UnitPrice,Quantity")] OrderDetail orderDetail)
        {
            ...
            ViewData["OrderId"] = new SelectList(_context.Orders, "OrderId", "ShipAddress", orderDetail.OrderId);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'FoodyContext.OrderDetails'  is null.");
            }
            var orderDetail = await _context.OrderDetails.FindAsync(id);
            if (orderDetail != null)
            {
