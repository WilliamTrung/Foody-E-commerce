...
namespace ApplicationCore.Migrations
{
    public partial class initdb : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Accounts",
                columns: new[] { "AccountId", "Address", "Password", "Phone", "RoleId", "Username" },
                values: new object[] { 1, "", "123", "0908123456", 1, "Administrator" });

            migrationBuilder.InsertData(
                table: "Accounts",
                columns: new[] { "AccountId", "Address", "Password", "Phone", "RoleId", "Username" },
                values: new object[] { 2, "", "123", "0908123456", 2, "Member" });

            migrationBuilder.InsertData(
                table: "Accounts",
                columns: new[] { "AccountId", "Address", "Password", "Phone", "RoleId", "Username" },
                values: new object[] { 3, "", "123", "0908123456", 3, "Seller" });
